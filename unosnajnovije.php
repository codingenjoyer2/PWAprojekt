...
<html>
    ...
    document.getElementById("slanje").onclick = function(event) {
        ...
        if (about.length < 10 || about.length > 50) {
            ...
            document.getElementById("porukaAbout").innerHTML="Kratki sadržaj vijesti mora imati između 10 i 50 znakova!<br>";
        } else {
        ...
        if (content.length === 0) {
            ...
            document.getElementById("porukaContent").innerHTML="Sadržaj vijesti mora biti unesen!<br>";
        } else {
        ...
        if(poljeCategory.selectedIndex === 0) {
            ...
            document.getElementById("porukaKategorija").innerHTML="Kategorija vijesti mora biti odabrana!<br>";
        } else {
